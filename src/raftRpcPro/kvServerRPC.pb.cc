...
static constexpr ::PROTOBUF_NAMESPACE_ID::Metadata* file_level_metadata_kvServerRPC_2eproto = nullptr;
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_kvServerRPC_2eproto::offsets[1] = {};
...
const char descriptor_table_protodef_kvServerRPC_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\021kvServerRPC.proto"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_kvServerRPC_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_kvServerRPC_2eproto_sccs[1] = {
};
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_kvServerRPC_2eproto = {
  false, false, descriptor_table_protodef_kvServerRPC_2eproto, "kvServerRPC.proto", 19,
  &descriptor_table_kvServerRPC_2eproto_once, descriptor_table_kvServerRPC_2eproto_sccs, descriptor_table_kvServerRPC_2eproto_deps, 0, 0,
  schemas, file_default_instances, TableStruct_kvServerRPC_2eproto::offsets,
  file_level_metadata_kvServerRPC_2eproto, 0, file_level_enum_descriptors_kvServerRPC_2eproto, file_level_service_descriptors_kvServerRPC_2eproto,
};
